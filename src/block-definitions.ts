			...
			args0: [
				{
					...
					name: 'MARKCOLOR',
					options: [
						[{ src: 'blockly-img/mark_red.png', width: 24, height: 24, alt: '赤マーカー' }, 'RED'],
						[{ src: 'blockly-img/mark_blue.png', width: 24, height: 24, alt: '青マーカー' }, 'BLUE'],
						[{ src: 'blockly-img/mark_green.png', width: 24, height: 24, alt: '緑マーカー' }, 'GREEN'],
						[{ src: 'blockly-img/mark_yellow.png', width: 24, height: 24, alt: '黄マーカー' }, 'YELLOW'],
					],
				},
			],
		});
