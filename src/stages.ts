...
const stages: Stage[] = [
...

	{
		map: [
			...
			[24,  6,  2,  4,  2,  5,  2,  7, 10,  2,  3, 26],
			[24,  2, 41,  2, 41,  2, 41,  2, 30, 31, 11, 26],
			[24,  2, 43,  2, 43,  2, 43,  2, 32, 33, 10, 26],
			[24,  4,  2,  8,  8,  6,  2,  5,  8,  8,  7, 26],
			[24,  2, 57,  2, 57,  2, 57,  2, 34, 36,  2, 26],
			[24,  8,  2,  5,  2,  4,  2,  9,  2,  2,  8, 26],
			[24,  2, 57,  2, 57,  2, 57,  2, 34, 36,  2, 26],
			[24,  8,  2,  4,  2,  5,  2,  8,  2,  2,  5, 26],
			[24,  2, 57,  2, 57,  2, 57,  2, 34, 36,  2, 26],
			[24,  2,  2,  5,  8,  8,  2,  5,  2,  2,  8, 26],
			[27, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 29],
		],
		name: '08:"HOGE"',
